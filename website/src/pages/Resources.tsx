      ...
      <section className="resource-section">
        ...
        <div className="resource-grid">
          <div className="resource-card">
            ...
            <p>
              Presentations that educate students and families about their legal
              rights and practical steps to protect themselves
            </p>
          </div>
          ...
          <div className="resource-card">
            ...
            <p>
              {" "}
              Sessions that explain immigration law and policy changes that may
