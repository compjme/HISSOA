      ...
      <main className="resources-page">
        <div className="transparent-card">
          <section className="resources-hero">
            ...
            <p>
              {" "}
              HISSOA connects immigrant students and families with trusted
              legal, educational, and community resources
            </p>
          </section>
          ...
          <section className="resource-section">
            ...
            <p>
              Students can stay informed about changes that may affect DACA,
              work permits, visas, citizenship, and other immigration-related
              matter
            </p>
          ...
          <section className="resource-section">
            ...
            <div className="resource-grid">
              ...
              <div className="resource-card">
                ...
                <p>
                  workshops designed to help families stay informed, prepared
                  and supported.{" "}
                </p>
              </div>
            </div>
          ...
          <section className="resource-disclaimer">
            <p>
              ...
              Non-students should contact qualified legal professional or
              trusted organizations for guidance about their specific situation
            </p>
          </section>
        </div>
      </main>
